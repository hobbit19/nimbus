...
# Nimble expects nimbleDir to be an absolute path
NIMBLE := nimble -y --nimbleDir:"$(CURDIR)/$(NIMBLE_DIR)"
...
.PHONY: all deps github-ssh build-nim update status ntags ctags nimbus test clean mrproper
